                                            ...
                                            <div class="col-lg-12 mb-1">
                                                <div class="single-blog-item">
                                                    <div class="row d-flex justify-content-center">
                                                        <div class="col-lg-6">
                                                            <img :src="'/storage/'+ produkkamiData.produkkami.product_image" :alt="produkkamiData.produkkami.product_name" class="img-fluid shadow">
                                                        </div>
                                                    </div>

                                                    <div class="blog-item-content mt-5 pl-4 pr-4">
                                                        <div class="blog-item-meta mb-3">
                                                            <span class="text-color-2 text-capitalize mr-3"><i class="icofont-book-mark mr-2"></i>Harga: {{ numberFormat(produkkamiData.produkkami.price) }}</span>
                                                            <span class="text-black text-capitalize mr-3 float-right"><i class="icofont-calendar mr-2"></i>  {{ $diffForHumans(produkkamiData.produkkami.created_at) }}</span>
                                                        </div>
                                                        <h2 class="mb-4 text-md">{{ produkkamiData.produkkami.product_name }}</h2>

                                                        <p v-html="produkkamiData.produkkami.product_description"></p>
